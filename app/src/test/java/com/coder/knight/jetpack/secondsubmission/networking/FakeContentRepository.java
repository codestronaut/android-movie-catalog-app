...
public class FakeContentRepository {
    ...
    public FakeContentRepository(@NonNull RemoteRepository remoteRepository) {
        this.remoteRepository = remoteRepository;
    }

    public static FakeContentRepository getInstance(RemoteRepository remoteData) {
        if (INSTANCE == null) {
            synchronized (FakeContentRepository.class) {
                if (INSTANCE == null) {
                    INSTANCE = new FakeContentRepository(remoteData);
                }
            }
        }
